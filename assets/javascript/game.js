    ...
    if (currentWord.indexOf(userGuess) > -1) {
        ...
        if (underScore.join('') == currentWord) {
            ...
            if (currentWord == "surfboard") {
                ...
                document.getElementById('fill-text').innerHTML = "The surfboard was invented in ancient Hawaii where they were carved from the wood of localtrees.  There have been some major advancements over the years though and currently more than 400,000 boards are manufactured each year.";
            }
            else if (currentWord == "wipeout") {
                document.getElementById('fill-image').src = "assets/images/wipeout.jpg";
                document.getElementById('fill-text').innerHTML = "A wipeout is when a surfer falls or is knocked off the board.  While underwater, the power ofthe wave can shake the surfer around which is called being 'rag-dolled'.  In fact, 113 people died in 2017 while surfing.";
            }
            else if (currentWord == "barney") {
                document.getElementById('fill-image').src = "assets/images/barney.jpg";
                document.getElementById('fill-text').innerHTML = "A Barney is a new or untalented surfer, also refered to as a Stu or a kook.  This term canalsorefer to someone who is ignorant of proper surf etiquette.";
            }
            else if (currentWord == "quiver") {
                document.getElementById('fill-image').src = "assets/images/quiver.jpg";
                document.getElementById('fill-text').innerHTML = "A quiver is a surfer's collection of boards.  Typically consisting of three to six boards aquiver is the surfing equivalent to a golfer's bag of clubs.";
            }
            else if (currentWord == "hangten") {
                document.getElementById('fill-image').src = "assets/images/hangten.jpg";
                document.getElementById('fill-text').innerHTML = "Hang Ten is a surfing manuever in which the surfer positions the board in such a way that theycan stand and hang all ten toes over the nose of the board.";
            }
                ...
                document.getElementById('fill-text').innerHTML = "A Hang Ten is a surfing maneuverin which the surger positions the surfboard in such a way thatthey can stand and hang all ten toes over the nose of the board.";
            };
